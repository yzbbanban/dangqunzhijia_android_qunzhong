...
class MyAttentionActivity : BaseActivity() {
    ...
    override fun initView() {
        ...
        AgentWebConfig.syncCookie(UrlConstant.BASE_URL_MY_ATTENTION,"${Constants.UID}=$uid")
        AgentWebConfig.syncCookie(UrlConstant.BASE_URL_MY_ATTENTION,"${Constants.TOKEN}=$token")
        mAgentWeb = AgentWeb.with(this)
                ...
                .createAgentWeb()
                .ready()
                .go(UrlConstant.BASE_URL_MY_ATTENTION)
