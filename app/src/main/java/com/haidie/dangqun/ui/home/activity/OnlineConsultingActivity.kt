 ...
 * description  在线咨询
 */
class OnlineConsultingActivity : BaseActivity(){
    ...
    override fun initView() {
        ...
        AgentWebConfig.syncCookie(UrlConstant.BASE_URL_ONLINE_CONSULTING,"${Constants.UID}=$uid")
        AgentWebConfig.syncCookie(UrlConstant.BASE_URL_ONLINE_CONSULTING,"${Constants.TOKEN}=$token")
        mAgentWeb = AgentWeb.with(this)
                ...
                .createAgentWeb()
                .ready()
                .go(UrlConstant.BASE_URL_ONLINE_CONSULTING)
