...
class MyFansActivity : BaseActivity() {
    ...
    override fun initView() {
        ...
        AgentWebConfig.syncCookie(UrlConstant.BASE_URL_MY_FANS,"${Constants.UID}=$uid")
        AgentWebConfig.syncCookie(UrlConstant.BASE_URL_MY_FANS,"${Constants.TOKEN}=$token")
        mAgentWeb = AgentWeb.with(this)
                ...
                .createAgentWeb()
                .ready()
                .go(UrlConstant.BASE_URL_MY_FANS)
