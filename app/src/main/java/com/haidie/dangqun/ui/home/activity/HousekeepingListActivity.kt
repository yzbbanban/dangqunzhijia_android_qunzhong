...
import com.haidie.dangqun.ui.home.androidinterface.AndroidHousekeepingListInterface
 ...
 * description  家政服务列表
 */
class HousekeepingListActivity : BaseActivity() {
    ...
    companion object {
        fun start(context: FragmentActivity, url: String){
            val intent = Intent(context, HousekeepingListActivity::class.java)
    ...
    override fun initView() {
        ...
        mAgentWeb!!.jsInterfaceHolder.addJavaObject(Constants.ANDROID, AndroidHousekeepingListInterface(this))
    ...
    fun toHousekeepingDetail(url: String){
        HousekeepingDetailActivity.start(this@HousekeepingListActivity,url)
    }
}