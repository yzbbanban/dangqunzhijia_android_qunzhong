...
import com.haidie.dangqun.ui.home.activity.EventAnnouncementsDetailActivity
 ...
 * description
 */
class CaringActivitiesListFragment : BaseFragment(), VolunteerActivitiesListContract.View {
    ...
    companion object {
        fun getInstance(position: Int): CaringActivitiesListFragment {
            val fragment = CaringActivitiesListFragment()
            val bundle = Bundle()
            fragment.arguments = bundle
            fragment.status = position
            return fragment
        }
    }
    ...
    private fun initRecyclerView() {
        ...
        mAdapter.setOnItemClickListener{ _, _, position ->
            val intent = Intent(activity, EventAnnouncementsDetailActivity::class.java)
