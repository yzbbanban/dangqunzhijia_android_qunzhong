...
class MyArticleActivity : BaseActivity() {
    ...
    override fun initView() {
        ...
        AgentWebConfig.syncCookie(UrlConstant.BASE_URL_MY_ARTICLE,"${Constants.UID}=$uid")
        AgentWebConfig.syncCookie(UrlConstant.BASE_URL_MY_ARTICLE,"${Constants.TOKEN}=$token")
        mAgentWeb = AgentWeb.with(this)
                ...
                .createAgentWeb()
                .ready()
                .go(UrlConstant.BASE_URL_MY_ARTICLE)
